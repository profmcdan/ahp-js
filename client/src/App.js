...
import BidResult from "./components/Result/BidResult";
import BidResultList from "./components/Result/BidResultList";
      ...
      <Router>
        <div className="ui container">
          ...
          <Switch>
            ...
            <Route
              exact
              path="/new-alternative/:bid_id"
              component={NewAlternative}
            />
            <Route
              exact
              path="/update-alternative"
              component={EditAlternative}
            />

            <Route
              exact
              path="/decision-criteria/:bid_id"
              component={CompareCriteria}
            />
            <Route
              exact
              path="/add-alt/:bid_id/:criteria_id/sub/:subcriteria_id"
              component={CompareAlternative}
            />
            <Route
              exact
              path="/add-sub/:bid_id/:criteria_id"
              component={CompareSubCriteria}
            />

            <Route exact path="/bids" component={Bids} />
            <Route exact path="/bid/:id" component={BidDetail} />
            <Route exact path="/bid/result/:id" component={BidResult} />
            <Route exact path="/bid/results/:id" component={BidResultList} />
            <Route exact path="/bid-user/:id" component={BidDetails} />
            <Route
              exact
              path="/bid/:bid_id/:criteria_id"
              component={AddSubCriteria}
            />
            <Route
              exact
              path="/alt/:bid_id/:contractor_id"
              component={EditAlternative}
            />
